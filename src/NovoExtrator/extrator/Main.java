...
public class Main {
    ...
    public static void TestTags() {
        ...
        String s = "FistName : SecondName <html><body><a href=''>Testing</a> Working? </body><html> Test";
...
////        System.exit(0);
        if (!ht.loadPreviousRecordedFileToHash("dadoshash_basebib2MEDIA.txt")) {
...
//                if (s.getAbsolutePath().indexOf(".txt") == -1) continue;
            ...
            for (final File s : g.listFiles()) {
                 ...
                 * *************************************************
                 */
                if (s.isFile() && s.getName().substring(s.getName().length() - 4).equalsIgnoreCase("html")) {
                    /**
                     * *************************************************
                     */
                    ...
                    //LinkedList<TokenNP> wl = ExtractorHTMLList.mountList(nomearq, lc, ht, hsw, hci, fc);
                    LinkedList<String> l = lc._getCitations(st, lc.getList(), hsw, filename);
                     ...
                     * **************************************
                     */
                    String nomeSaida = nomearq.replace("testes/TesteHTML/testeRPI/",
                            "testes/TesteHTML/testeRPI/saida1/") + "_saida.html";
            ...
            if (lc.getType().equalsIgnoreCase("txt")) {
                ...
                //generateFile(nomeSaida, lc.getList(), c, 0, 0);
                //system.out.println(Main.printCits(cits));
